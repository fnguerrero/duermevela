...
var Guion = (function () {
  ...
  var CARTA_PARA_BEL = {
    parrafos: [
      ...
      'Solamente deseo que, con el tiempo, puedas encontrar un poquito de paz. Que los recuerdos lindos puedan empezar a pesar más que el dolor. Y que, de a poquito, puedas volver a sonreír, disfrutar de las cosas, hacer planes, reírte mucho y sentirte orgullosa de la persona que sos.',

      'Porque creo que hay personas que dejan una parte de ellas en nosotros que permanece para siempre. Y quizás una de las formas más lindas de llevarlas con nosotros sea justamente seguir viviendo: sonreír, disfrutar, hacer planes, cumplir sueños y ser felices. Hacer de todo eso nuestro motor, también por ellas.',
